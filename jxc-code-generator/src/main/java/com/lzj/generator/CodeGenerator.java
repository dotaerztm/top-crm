...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/ERP/002_code/jxc-manager-par/jxc-admin/src/main/java");
        //作者
        gc.setAuthor("ch_ztm");
        //打开输出目录
        gc.setOpen(false);
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/ERP/002_code/jxc-manager-par/jxc-admin/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper"
                        + StringPool.DOT_XML;
            }
        });
