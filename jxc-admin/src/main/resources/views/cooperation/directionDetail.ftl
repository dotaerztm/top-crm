...
<#--        <button id = "addInfo" type="button" class="layui-btn  layui-btn-danger layui-btn-fluid">添加商业方向</button>-->
    </div>
...
<script>
    ...
    layui.use(['table','layer'],function(){
        ...
        table.render({
            elem: '#test'
            ,url: '/cooperation/selectImageDetailFromTableByDirection'
            ...
            ,cols: [[
                ...
                ,{field:'url', title: '图片',width: '30%', align: 'center',sort:false,
            ...
            if(res.event == 'del'){//删除
                ...
                layer.open({
                    ...
                    success: function(layero, index){
                        ...
                        body.find("#detailPath").val(res.data.url);
                        body.find("img[id='ID-upload-img-detail']").attr('src',res.data.url);
