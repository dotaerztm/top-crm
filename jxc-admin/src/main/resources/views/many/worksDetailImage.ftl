...
<script>
    ...
    layui.use(['table','layer'],function(){
        ...
        table.render({
            elem: '#test'
            ,url: '/many/selectImageDetailFromTableByWorks'
            ...
            ,cols: [[
                ...
                ,{field:'url', title: '图片',width: '30%', align: 'center',
        ...
        table.on('tool(demo)',function (res){
            if(res.event == 'del'){//删除
                ...
                layer.open({
                    type:2,//iframe弹出层
                    title:'修改详情图',
                    content:"worksDetailImageUpdate",
