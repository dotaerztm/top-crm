...
<script>
    ...
    layui.use(['table','layer'],function(){
        ...
        table.render({
            elem: '#test'
            ,url: '/university/selectImageFromTableByGradeTwo'
            ...
            ,cols: [[
                ...
                ,{field:'introduction1', title: '介绍图1',width: '15%', align: 'center',sort:false,
                    templet:function (res) {
                        let photograph = '<div lay-event="photograph-introduction1"><img src='+res.introduction1+'></div>';
                        return photograph;
                    }
                }
                ,{field:'introduction2', title: '介绍图2',width: '15%', align: 'center',sort:false,
                    templet:function (res) {
                        let photograph = '<div lay-event="photograph"><img src='+res.introduction2+'></div>';
                        return photograph;
                    }
                }
