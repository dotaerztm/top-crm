            ...
            <div class="layui-row">
                <form class="layui-form" action="" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="remarks" id="remarks" required  lay-verify="required" placeholder="请输入描述信息" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea name="classTimeContent" id="classTimeContent" placeholder="输入ClassTime文本" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="assignmentMiddle" id="assignmentMiddle" required  lay-verify="required" placeholder="Assignment课程价格" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea name="assignmentContent"  id="assignmentContent" placeholder="输入Assignment文本" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="assignmentLink" id="assignmentLink" required  lay-verify="required" placeholder="请输入Assignment外链" autocomplete="off" class="layui-input">
                        </div>
                    </div>
