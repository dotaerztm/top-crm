            ...
            <div class="layui-row">
                <form class="layui-form" action="" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="remarks" id="remarks" readonly  lay-verify="required" placeholder="请输入描述信息" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="group" id="group" readonly  lay-verify="required" placeholder="请输入part数字" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="sort" id="group" required  lay-verify="required" placeholder="请输入排序数字" autocomplete="off" class="layui-input">
                        </div>
                    </div>
...
<script>
    ...
    layui.use(function(){
        ...
        form.on('submit(formDemo)', function(data){
            $.ajax({
                url: '/image/saveDetailByGrade/',//保存接口
                method:'post',
                async: false,
