...
<body>
    <div class="layui-container">
        ...
        <button id = "addInfo" type="button" class="layui-btn  layui-btn-danger layui-btn-fluid">添加公益课</button>
    </div>
...
<script>
    ...
    layui.use(['table','layer'],function(){
        ...
        table.render({
            elem: '#test'
            ,url: '/university/selectImageFromTableByPublicWelfare'
